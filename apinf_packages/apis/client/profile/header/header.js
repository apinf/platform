...
Template.viewApiPageHeader.onRendered(() => {
  ...
  $(function() {
    ...
    var $nav = $('nav.api-profile_navigation');
    var $btn = $('nav.api-profile_navigation button');
    var $vlinks = $('nav.api-profile_navigation .links');
    var $hlinks = $('nav.api-profile_navigation .hidden-links');
