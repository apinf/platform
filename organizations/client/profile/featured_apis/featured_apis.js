...
Template.organizationFeaturedApis.helpers({
  apis () {
    ...
    // console.log('apis_instance=', instance);
    // console.log('f-apis=', instance.data.organization.featuredApiIds);
    // const featuredApiList = instance.data.organization.featuredApiIds;
  ...
  hasFeaturedApi () {
    const instance = Template.instance();
    console.log('has_api_instance=', instance);
    // Get documents
    const apis = instance.pagination.getPage();
    ...
    // return (instance.data.organization.featuredApiIds.length);
  },
});
