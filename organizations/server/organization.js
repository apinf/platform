  ...
  endpoints: {
    ...
    post: {
      ...
      action () {
        ...
        const organizationData = {
          ...
          createdBy: userId,
          contact: {
            person: bodyParams.manager_name,
            phone: bodyParams.manager_phone,
            email: bodyParams.manager_email,
          },
          socialMedia: {
    ...
    put: {
      ...
      action () {
        ...
        if (organization && organization.managerIds.indexOf(userId) > -1) {
          // If bodyParams doesn't contain any fields
          // then organizationData JSON doesn't contain it as well
          const organizationData = {
            name: bodyParams.name,
    ...
    delete: {
      ...
      action () {
        ...
        // Make sure Organization exists & user can manage
        if (organization && organization.currentUserCanManage(userId)) {
