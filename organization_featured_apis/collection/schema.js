...
import OrganizationFeaturedApis from './';

OrganizationFeaturedApis.schema = new SimpleSchema({
  organizationId: {
    type: String,
    optional: false,
    autoform: {
...
OrganizationFeaturedApis.schema.i18n('schemas.organizationFeaturedApis');

// Attach schema to collection
OrganizationFeaturedApis.attachSchema(OrganizationFeaturedApis.schema);
