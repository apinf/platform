...
test.describe('View API Backend', function() {
    ...
    test.it('9.2 should send feedback', function() {
        ...
        driver.findElement(By.xpath('//*[@id="feedbackFormModal"]//form[@id="feedbackForm"]//div[1]/input')).sendKeys('Test Feedback');
        driver.findElement(By.xpath('//*[@id="feedbackFormModal"]//form[@id="feedbackForm"]//div[2]/textarea')).sendKeys('Test Message');
        driver.findElement(By.xpath('//*[@id="feedbackFormModal"]//form[@id="feedbackForm"]//div[3]/select/option[2]')).click();
        driver.findElement(By.xpath('//*[@id="feedbackFormModal"]//form[@id="feedbackForm"]/div[2]/button')).click();
