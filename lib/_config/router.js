...
var additionalSetupRequired = function () {
    Meteor.call('additionalSetupRequired', function(error, result) {
      // if result is false/undefined, go the settings wizard
      if (result) {
...
// not sure how to check additionalSetupRequired for all routes
// the below implementation causes an infinite redirect loop at sign-in
