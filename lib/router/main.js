...
// Temporary metadata route, cleanup when done
Router.route("/api/:apiId/metadata", function () {
  this.layout("masterLayout");
  this.render("viewApiBackendMetadata");
}, {
  name: "viewApiBackendMetadata"
});
