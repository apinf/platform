...
Schemas.SubSettings = new SimpleSchema({
  "sub_settings.$.disable_api_key": {
    type: Boolean,
    optional: true
  },
...
Schemas.Rewrites = new SimpleSchema({
  "rewrites.$.matcher_type": {
    type: String,
    optional: true,
    allowedValues: [
      'Route Pattern',
...
Schemas.ApiBackendsSchema = new SimpleSchema({
  ...
  sub_settings: {
    type: Schemas.SubSettings,
    label: 'Sub Settings',
    optional: true
  },
  rewrites: {
    type: Schemas.Rewrites,
    optional: true
  },
  error_templates: {
    type: [Object],
